...
class TestIndexGlobalOptions < MiniTest::Test
  ...
  def test_index_set_global_options_None
    @cindex.global_options = Clangc::GlobalOptFlags::None
    assert_equal Clangc::GlobalOptFlags::None, @cindex.global_options
  end
  def test_index_set_global_options_and_editing
    flags =  @cindex.global_options | Clangc::GlobalOptFlags::Threadbackgroundpriorityforediting
    puts flags
